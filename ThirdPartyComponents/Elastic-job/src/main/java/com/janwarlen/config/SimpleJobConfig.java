...
import com.janwarlen.job.SpringSimpleJob;
...
public class SimpleJobConfig {
    ...
    public JobScheduler simpleJobScheduler(final SimpleJob simpleJob,
               @Value("${com.janwarlen.elasticjob.simpleJob.supplier.service.cron}") final String cron,
               @Value("${com.janwarlen.elasticjob.shardingTotalCount}") final int shardingTotalCount,
               @Value("${com.janwarlen.elasticjob.shardingItemParameters}") final String
