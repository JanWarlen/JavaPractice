...
public class StormSubmitter {
    public static final Logger LOG = LoggerFactory.getLogger(org.apache.storm.StormSubmitter.class);
    ...
    public static void pushCredentials(String name, Map stormConf, Map<String, String> credentials)
        ...
        try {
            if (localNimbus != null) {
                ...
                } catch (org.apache.storm.thrift.TException e) {
     ...
     * @thorws SubmitterHookException if any Exception occurs during initialization or invocation of registered {@link ISubmitterHook}
     */
    public static void submitTopologyAs(String name, Map stormConf, StormTopology topology, SubmitOptions opts, org.apache.storm.StormSubmitter.ProgressListener progressListener, String asUser)
        ...
        try {
            if (localNimbus != null) {
                ...
                try {
                    LOG.info("Submitting topology {} in distributed mode with conf {}. jar:{}", name, serConf, jar);
    ...
    @SuppressWarnings("unchecked")
    public static void submitTopology(String name, Map stormConf, StormTopology topology, SubmitOptions opts,
                                      org.apache.storm.StormSubmitter.ProgressListener progressListener) throws AlreadyAliveException, InvalidTopologyException, AuthorizationException {
    ...
    public static void submitTopologyWithProgressBar(String name, Map stormConf, StormTopology topology, SubmitOptions opts) throws AlreadyAliveException, InvalidTopologyException, AuthorizationException {
        ...
        submitTopology(name, stormConf, topology, opts, new org.apache.storm.StormSubmitter.ProgressListener() {
            @Override
    ...
    private static String submitJar(Map conf, org.apache.storm.StormSubmitter.ProgressListener listener) {
    ...
    public static String submitJarAs(Map conf, String localJar, org.apache.storm.StormSubmitter.ProgressListener listener, String asUser) {
        if (localJar == null) {
     ...
     * @return the remote location of the submitted jar
     */
    public static String submitJar(Map conf, String localJar, org.apache.storm.StormSubmitter.ProgressListener listener) {
